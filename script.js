const data = 
    ...
    function renderRow(object) {
        ...
        tr.innerHTML =
          '<td class="' + class_map[object.color] + '">' + object.place + '</td>' +
          //td_class(row.color) + row.place + '</td>' +        
          '<td class="left"><img src=\"http://icons.iconarchive.com/icons/hopstarter/flag-borderless/16/Italy-icon.png\" align=\"left\"><a href =\"'+ object.tag_url +'\">' + object.name + '</a></td>' +
          '<td>' + object.matches + '</td>' +
          '<td>' + object.win + '</td>' +
          '<td>' + object.draw + '</td>'+
          '<td>' + object.lose + '</td>'+
          '<td>' + object.goals + '</td>'+
          '<td>' + object.conceded_goals + '</td>'+
          '<td>' + object.score + '</td>';
